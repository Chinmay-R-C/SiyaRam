...
rst=stmt.executeQuery("select password from services where username='"+request.getParameter("email")+"' ");
if(rst.next()){
//----------------------
  String result;
  ...
  final String from = " 22p12rsvp@gmail.com";

    final String pass = " rudjzatlbwhxgxfg";
...
window.open("servicelogin.jsp","_self");
</script>
<%
