...
<table width="auto" border="1" align="center">
  ...
  <tr bgcolor="#003399">
    ...
    <td><input name="update" type="submit" id="update" value="Book My service" />
      </td>
  </tr>
  </form>
  <% } %>
...
String s4=(String)session.getAttribute("cid");


int x=stmt.executeUpdate("insert into booking(servicename,category,sid,cphone) values('"+s1+"','"+s2+"','"+s3+"','"+s4+"') ");
if(x!=0)
{
%>
<script>
