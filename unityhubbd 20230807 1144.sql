...
--
-- Create schema unityhubservices
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ unityhubservices;
USE unityhubservices;

--
-- Table structure for table `unityhubservices`.`booking`
--
...
--
-- Dumping data for table `unityhubservices`.`booking`
--
...
--
-- Table structure for table `unityhubservices`.`catering`
--
...
--
-- Dumping data for table `unityhubservices`.`catering`
--
...
--
-- Table structure for table `unityhubservices`.`customer`
--
...
--
-- Dumping data for table `unityhubservices`.`customer`
--
...
--
-- Table structure for table `unityhubservices`.`feedback`
--
...
--
-- Dumping data for table `unityhubservices`.`feedback`
--
...
--
-- Table structure for table `unityhubservices`.`login`
--
...
--
-- Dumping data for table `unityhubservices`.`login`
--
...
--
-- Table structure for table `unityhubservices`.`payment`
--
...
--
-- Dumping data for table `unityhubservices`.`payment`
--
...
--
-- Table structure for table `unityhubservices`.`services`
--
...
--
-- Dumping data for table `unityhubservices`.`services`
--
